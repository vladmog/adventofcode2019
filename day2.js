...
// two indicate the positions from which you should read the input values, and the third indicates 
...
// Again, the three integers after the opcode indicate where the inputs and outputs are, not 
// their values.
...
// contain 70 and 50 respectively. Multiplying these produces 3500; this is stored 
// at position 0:
...
// program (your puzzle input) to the "1202 program alarm" state it had just before the last 
// computer caught fire. To do this, before running the program, replace position 1 with the value 
// 12 and replace position 2 with the value 2. What value is left at position 0 after the program 
// halts?
...
console.log(compute(puzzleInput))